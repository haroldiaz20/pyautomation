...
from views.welcome import Ui_WelcomeWindow
...
class WelcomeController(Ui_WelcomeWindow):
    
    def __init__(self, mainWindow, username=None, token=None):
        
        Ui_WelcomeWindow.__init__(self)      
        
        self.setupUi(mainWindow)

        self.dialogGeneralProjects = mainWindow
        mainWindow.setWindowFlags(QtCore.Qt.WindowTitleHint  | QtCore.Qt.WindowMinimizeButtonHint | QtCore.Qt.WindowCloseButtonHint)  #| QtCore.Qt.WindowCloseButtonHint
        mainWindow.setFixedSize(mainWindow.width(), mainWindow.height())
        
        self.mainWindow = mainWindow
        
        # List projects selection mode and click event
        ...
        # Change window title
        mainWindow.setWindowTitle(self.username + " - My projects")	
